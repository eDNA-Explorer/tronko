...
void freeMemForResults ( resultsStruct *results, int sizeOfChunk, int numberOfTrees, int num_threads, int paired, int use_nw, int use_portion, int maxNumSpec, int number_of_total_nodes, int max_bwa_matches);
